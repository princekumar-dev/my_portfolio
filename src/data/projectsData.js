export const projectsData = [
  {
    ...
    liveUrl: 'https://github.com/princekumar-dev/Academics--2',
    image: '/academics.png',
    color: '#3b82f6',
    featured: true,
    status: 'Completed'
  },
  {
    ...
    liveUrl: 'https://github.com/princekumar-dev/Connect',
    image: '/connect.png',
    color: '#06b6d4',
    featured: true,
    status: 'Completed'
  },
  {
    ...
    liveUrl: 'https://github.com/princekumar-dev/Busy_Bot',
    image: '/busybot.png',
    color: '#10b981',
    featured: true,
    status: 'Completed'
  },
  {
    ...
    liveUrl: 'https://github.com/princekumar-dev/FocusForge',
  ...
  },
  {
    ...
    liveUrl: 'https://github.com/princekumar-dev/Logipilot',
    image: '/logipilot.png',
    color: '#ef4444',
    featured: true,
    status: 'Completed'
